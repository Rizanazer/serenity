...
function GroupList_1({ userid, data, HandleClick, setViewChat }) {
    ...
    return (
      ...
      <div className="box chat pointer minheight" style={{borderRadius:0}} onClick={() => { setViewChat(true); HandleClick(data._id, data.communityName,data.communityIcon); }}>
